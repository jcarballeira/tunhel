...
//Las imágenes se graban desde una distancia determinada
...
// FUNCIÓN ENCARGADA DE SEGMENTAR Y PUBLICAR AGUJEROS Y ALREDEDORES
{
    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud (new pcl::PointCloud<pcl::PointXYZ>); // NUBE
    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_ROI (new pcl::PointCloud<pcl::PointXYZ>); // CUADRADO MÁS AGUJERO (REGIÓN DE INTERÉS)
    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_hole (new pcl::PointCloud<pcl::PointXYZ>); // PARTE AGUJERO
    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_rest (new pcl::PointCloud<pcl::PointXYZ>); // PARTE SIN AGUJERO
