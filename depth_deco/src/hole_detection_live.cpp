...
void cylinderModel (pcl::PointCloud<pcl::PointXYZ>::Ptr cloud) //Cylinder model obtention and publishing from a ransac segmented point cloud
{
    ...
    seg.setRadiusLimits (0.005, 0.05);
...
{   bool fp=false;
    ...
    pcl::fromROSMsg (*cld_msg, *cloud); //Formato pcl2 a nube cloud (sensor_msg a pointxyz)
    ...
    sensor_msgs::PointCloud2 cloud_ROI_msg; // PASO INVERSO PARA PUBLICAR
    pcl::toROSMsg (*cloud_ROI, cloud_ROI_msg);
    cloud_ROI_msg.header.frame_id = "world"; // TF RVIZ
